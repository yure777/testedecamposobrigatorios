/**
 * backbone model definitions for BDTESTE
 */
...
/**
 * Tabelatestando Backbone Model
 */
model.TabelatestandoModel = Backbone.Model.extend({
	urlRoot: 'api/tabelatestando',
	idAttribute: 'id',
	id: '',
	nome: '',
	sexo: '',
...
/**
 * Tabelatestando Backbone Collection
 */
model.TabelatestandoCollection = model.AbstractCollection.extend({
	url: 'api/tabelatestandos',
	model: model.TabelatestandoModel
});
