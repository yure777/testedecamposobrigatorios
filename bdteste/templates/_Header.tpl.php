...
<html lang="en">
	<head>
		...
		<meta name="description" content="BDTESTE" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">BDTESTE</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								<li <?php if ($this->nav=='tabelatestandos') { echo 'class="active"'; } ?>><a href="./tabelatestandos">Tabelatestandos</a></li>
								</ul>
								</li>
							</ul>
