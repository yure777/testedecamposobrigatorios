...
require_once("DAO/TabelatestandoCriteriaDAO.php");

/**
 * The TabelatestandoCriteria class extends TabelatestandoDAOCriteria and is used
 ...
 * @version 1.0
 */
class TabelatestandoCriteria extends TabelatestandoCriteriaDAO
{
