...
GlobalConfig::$CONNECTION_SETTING->DBName = "bdteste";
...
/** the root url of the application with trailing slash, for example http://localhost/bdteste/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'bdteste/';
